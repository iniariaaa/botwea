...
${isSurrender ? '' : `+${room.winScore} XP tiap jawaban benar`}
    `.trim()
        await this.sendButton(m.chat, caption, 'made with ❤️ by ariabotz', `${isWin ? 'FAMILY100' : isSurrender ? 'FAMILY100' : 'NYERAH'}`, `${isWin ? ',FAMILY100' : isSurrender ? ',FAMILY100' : 'NYERAH'}`, {
            contextInfo: {
