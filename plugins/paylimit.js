...
let handler = async (m, { conn, text, usedPrefix, command }) => {
    if (!text) {
        conn.reply(m.chat, `perintah ini buat ngasih limit ke pengguna lain\n\ncontoh:\n${usedPrefix + command} @62895622729068 10\natau balas pesan doi dengan perintah: ${usedPrefix + command} 10`, m, { contextInfo: { mentionedJid: ['62895622729068@s.whatsapp.net'] } })
        throw false
    }
    let who
